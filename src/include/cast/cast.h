...
extern "C"
{
    ...
    CAST_EXPORT int clariusInitCast(int argc,
        char** argv,
        const char* dir,
    ...
    CAST_EXPORT int clariusDestroyCast();
    ...
    /// @param[in] port the tcp port that the scanner's casting is setup on
    /// @param[in] fn callback to obtain success of call, if set to null, then the call will block
    /// @return success of the call
    /// @retval 0 the connection attempt was successful
    /// @retval -1 the connection attempt was not successful
    CAST_EXPORT int clariusConnect(const char* ipAddress, unsigned int port, ClariusReturnFn fn);
    ...
    CAST_EXPORT int clariusDisconnect(ClariusReturnFn fn);
    ...
    CAST_EXPORT int clariusIsConnected();
    ...
    CAST_EXPORT int clariusSetOutputSize(int w, int h);
    ...
    CAST_EXPORT int clariusSetNewRawImageFn(ClariusNewRawImageFn fn);
    ...
    /// @retval 0 the callback function was successfully set
    /// @retval -1 the callback function could not be set
    CAST_EXPORT int clariusSetNewProcessedImageFn(ClariusNewProcessedImageFn fn);
    ...
    /// @retval 0 the callback function was successfully set
    /// @retval -1 the callback function could not be set
    CAST_EXPORT int clariusSetFreezeFn(ClariusFreezeFn fn);
    ...
    /// @retval 0 the callback function was successfully set
    /// @retval -1 the callback function could not be set
    CAST_EXPORT int clariusSetButtonFn(ClariusButtonFn fn);
    ...
    /// @retval 0 the callback function was successfully set
    /// @retval -1 the callback function could not be set
    CAST_EXPORT int clariusSetProgressFn(ClariusProgressFn fn);
    ...
    /// @retval 0 the callback function was successfully set
    /// @retval -1 the callback function could not be set
    CAST_EXPORT int clariusSetErrorFn(ClariusErrorFn fn);
    ...
    CAST_EXPORT int clariusGetUdpPort();
    ...
    CAST_EXPORT int clariusRequestRawData(long long int start, long long int end, ClariusReturnFn fn);
    ...
    CAST_EXPORT int clariusReadRawData(void** data, ClariusReturnFn fn);
    ...
    CAST_EXPORT int clariusUserFunction(int cmd, double val, ClariusReturnFn fn);
}
